...
// import { Card, Tag, Timeline, Collapse, Input } from "antd"
...
export default Home = () => {
  return (
    ...
    //         console.log(value);
    //         return (
    //           <Card style={homeStyles.pktInfo}>
    //             <GetState state={value.state} key={value.key} />
    //             <li key={key}
    //               style={{ fontSize: "x-large", fontWeight: 777 }}>
    //               {value.pick_id}
    //             </li>
